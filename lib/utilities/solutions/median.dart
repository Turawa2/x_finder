              ...
              children: [
                ...
                AnimatedContainer(
                  ...
                  child: ElevatedButton(
                      ...
                      child: Text('$Show steps', style: const TextStyle(color: Colors.white, fontSize: 16.0,
                            fontFamily: 'Raleway', fontWeight: FontWeight.w400, letterSpacing: 1.0),)),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                   ...
                                   Text(
                                    'N/2 = $N / $divideByTwo = $divideAnswer',
                                    style: const TextStyle(
                                        fontSize: 20.0,
                                        fontWeight: FontWeight.w500),
                                  ),
...
class _TableHeadingState extends State<TableHeading> {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Text(
        widget.title,
        style: const TextStyle(fontSize: 16.0, fontFamily: 'Raleway',  fontWeight: FontWeight.bold),
      ),
    );
  }
}
