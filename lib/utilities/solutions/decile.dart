...
class Decile extends StatefulWidget {
  const Decile({super.key});

  //  Decile({super.key});
  // final TextEditingController controller;
  @override
  State<Decile> createState() => _DecileState();
}

class _DecileState extends State<Decile> {
  final cwidth = 400.0;
  var cheight = 0.0;
                          ...
                          child: InteractiveViewer(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'N/10 = $N / $divideByTen = $divideAnswer',
                                    style: const TextStyle(
                                        fontSize: 20.0,
                                        fontWeight: FontWeight.w500),
                                  ),
