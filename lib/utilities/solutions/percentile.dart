...
class Percentile extends StatefulWidget {
  const Percentile({super.key});

  //  Percentile({super.key});
  // final TextEditingController controller;
  @override
  State<Percentile> createState() => _PercentileState();
}

class _PercentileState extends State<Percentile> {
  final cwidth = 400.0;
  var cheight = 0.0;
...
//for values of X
  ...
  void answer() {
    setState(() {
      ...
      divideAnswer = N ~/ divideByPercentage;
                          ...
                          child: InteractiveViewer(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Image.asset('images/percentile.jpg'),
                                  largeSpace,
                                  const Divider(),
                                  ...
                                  Text(
                                    'N/100 = $N / $divideByPercentage = $divideAnswer',
                                    style: const TextStyle(
                                        fontSize: 20.0,
                                        fontWeight: FontWeight.w500),
                                  ),
